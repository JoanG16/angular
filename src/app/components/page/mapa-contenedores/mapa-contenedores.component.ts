...
  private initMap(): void {
    ...
    L.control.zoom({
      position: 'bottomright' // Cambiar la posición a la derecha
    }).addTo(this.map);
...
        let polygonOptions: L.PolylineOptions;
 ...
 if (this.filtersActive && !isFiltered) {
          ...
          polygonOptions = {
            color: '#1a1a1adf', // Borde muy oscuro
            fillColor: '#0e0e0ee0', // Relleno negro
            fillOpacity: 0.7, // Más opaco para que sea muy oscuro
