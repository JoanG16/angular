...
      nombre_del_dueno: '',
      codigo_local: '',
      ruc: '', // Inicializar nuevo campo
      correo: '', // Inicializar nuevo campo
      facebook: '',
      instagram: '',
      tiktok: '',
      telefono: '',
...
    this.nuevoLocal = {
      ...local,
      ruc: local.ruc || '', // Asignar valor existente o cadena vacía
      correo: local.correo || '', // Asignar valor existente o cadena vacía
...
      nombre_del_dueno: '',
      codigo_local: '',
      ruc: '', // Limpiar nuevo campo
      correo: '', // Limpiar nuevo campo
      facebook: '',
      instagram: '',
      tiktok: '',
      telefono: '',
...
    localPayload.descripcion = this.nuevoLocal.descripcion || undefined;
    localPayload.ruc = this.nuevoLocal.ruc || undefined; // Asegurar que se envía el nuevo campo
    localPayload.correo = this.nuevoLocal.correo || undefined; // Asegurar que se envía el nuevo campo
